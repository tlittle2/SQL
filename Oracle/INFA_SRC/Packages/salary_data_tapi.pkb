...
is
  ...
  , p_last_update_id salary_data_stg.last_update_id%type default null)
    ...
    exception
        when others then
        error_pkg.print_error('salary_data_tapi.ins');
        raise;
    end ins;
  ...
  , p_last_update_id salary_data_stg.last_update_id%type default null)
	...
	exception
        when others then
        error_pkg.print_error('salary_data_tapi.upd');
        raise;
    end upd;
    ...
    exception
        when others then
        error_pkg.print_error('salary_data_tapi.del');
        raise;
    end del;
   ...
   begin
	...
	exception
        when others then
        error_pkg.print_error('salary_data_tapi.get_row');
        raise;
   end get_row;
