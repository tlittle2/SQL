...
is
    ...
    exception
        when others then
        error_pkg.print_error('partition_table_parm_tapi.ins');
        raise;
    end ins;
    ...
    exception
        when others then
        error_pkg.print_error('partition_table_parm_tapi.upd');
        raise;
    end upd;
    ...
    exception
        when others then
        error_pkg.print_error('partition_table_parm_tapi.del');
        raise;
    end del;
