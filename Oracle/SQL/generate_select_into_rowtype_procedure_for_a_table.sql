...
|| '; exception when no_data_found then raise; when too_many_rows then raise; end get_' || columns.table_name || '_2;' -- change number here if you want multiple "getter" procedures
as stmnt
