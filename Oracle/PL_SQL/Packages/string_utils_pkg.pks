...
as
    ...
    BEGIN
        ...
        v_returnvalue := replace_str(p_value9, '%9');
        v_returnvalue := replace_str(p_value10, '%10');
        v_returnvalue := replace_str(p_value11, '%11');
        v_returnvalue := replace_str(p_value12, '%12');
        v_returnvalue := replace_str(p_value13, '%13');
        v_returnvalue := replace_str(p_value14, '%14');
        v_returnvalue := replace_str(p_value14, '%15');
